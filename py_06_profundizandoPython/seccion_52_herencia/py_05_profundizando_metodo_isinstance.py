class ListaSimple:
    # * Profundizando en El método isinstance() en Python
...
# * Profundizando en El método isinstance() en Python
# isinstance()
print("Es entero?", isinstance(10, int))  # salida: True
print("Es entero?", isinstance("Hola", int))  # salida: False
print("Es cadena?", isinstance("Hola", str))  # salida: True
print(
    "Es lista entero orden?", isinstance(lista_enteros_ordenada, ListaEnterosOrdenada)
)  # salida: True
print(
    "Es lista entero ?", isinstance(lista_enteros_ordenada, ListaEnteros)
)  # salida: True
print(
    "Es lista ordena?", isinstance(lista_enteros_ordenada, ListaOrdenada)
)  # salida: True
print(
    "Es lista simple?", isinstance(lista_enteros_ordenada, ListaSimple)
)  # salida: True
print("Es objecto?", isinstance(lista_enteros_ordenada, object))  # salida: True
print(
    "Es de varios tipos?",
    isinstance(lista_enteros_ordenada, (ListaEnteros, ListaSimple)),
)  # salida: True
